...
var Schwarzenegger = function(firstName, lastName, health, gender) {
...
Gustav = new Schwarzenegger("Gustav", "Schwarzenegger", 100, "Male")
Aurelia = new Schwarzenegger("Aurelia", "Schwarzenegger", 100, "Female")
...
woudl be as a warrior. */
  ...
  arnold.oneLiner.push("Stick around!")
...
var henchbat = function (firstName,health, boss, scream){
  this.firstName = firstName;
  this.Health = health;
  this.Boss = batman;
  this.Scream = scream;
...
Bob = new henchbat ("Bob", 70, batman, "hungry")
Gary = new henchbat ("Gary", 80, batman, "ouch")
Arvin = new henchbat ("Arvin", 90, batman, "sleepy")
...
arnold.shotgun = function(enemy1, enemy2, enemy3) {
      ...
      enemy2.health -= 100;
      enemy3.health -= 100;
    if (enemy.health <= 0) return enemy.scream[i];
    console.log(oneLiners[1])
  }
...
shotgun! Batman sends out three henchmen to take out Conan. */
  ...
  arnold.shotgun function(Bob, Gary, Arvin);
...
/* But batman was ready too. He was creating terminators, actual mechanical clones
 of Conan to defeat his nemesis. */
  ...
  var terminator = function (health, scream, firstName, age, puny) {
    this.Health = health;
    this.Scream = scream;
    this.Firstname = firstName;
    this.Age = age;
  ...
  T1 = new Terminator(50, "Poop", "T1", 1, true);
  T2 = new Terminator(50, "woof", "T2", 1, true);
  T3 = new Terminator(50, "meow", "T3", 1, true);
  T4 = new Terminator(50, "moo", "T4", 1, true);
  T5 = new Terminator(50, "arf", "T5", 1, true);
  T6 = new Terminator(50, "ribbit", "T6", 1, true);
  T7 = new Terminator(50, "pow", "T7", 1, true);
...
var friends = function(scream, health, bestFriend, age, puny) {
  this.Scream = scream;
  this.Health = health;
...
var Carl Weathers = new Friends("Whatsup!", 100, Arnold, 60, false);
var Kobe Bryant = new Friends("Kobe!", 150, Arnold, 36, false);
var Bobby = new Friends("hi", 30, Arnold, 2, true);
